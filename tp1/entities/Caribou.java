...
public void move() {
	if(this instanceof Terrestrial) {
		System.out.println("Your Caribou named " + getName() + " just move walking");
	}else if (this instanceof Aquatic) {
		System.out.println("Your Caribou named " + getName() + " just move swimming");
	}else {
		System.out.println("Your Caribou named " + getName() + " just move walking");
		System.out.println("Your Caribou named " + getName() + " just move swimming");
	}
...
public void eat(Eatable eatable) {
	if(this instanceof Omnivorus) {
		System.out.println("Your Caribou named " + getName() + " just eat viande");
		System.out.println("Your Caribou named " + getName() + " just eat herbe");
	}else if (this instanceof Herbivorus) {
	      if (eatable instanceof Vegetable) {
	          System.out.println("Your Caribou named " + getName() + " just eat herbe");
	          
	        } else {
	        	System.out.println("Your Caribou named " + getName() + " cannot eat viande");
	        }
